...
/**
 * @brief Shake gesture flag
 *
 * 0 : disabled \n
 * 1 : enabled \n
 */
#define VCONFKEY_WMS_SHAKE_GESTURE				"db/wms/shake_gesture_enable"


/**
 * @brief Palm over flag
 *
 * 0 : disabled \n
 * 1 : enabled \n
*/
#define VCONFKEY_WMS_PALM_OVER				"db/wms/palm_over_enable"

/**
 * @brief Palm swipe flag
 *
 * 0 : disabled \n
 * 1 : enabled \n
*/
#define VCONFKEY_WMS_PALM_SWIPE				"db/wms/palm_swipe_enable"

/**
 * @brief Summary panel flag
 *
 * 0 : disabled \n
 * 1 : enabled \n
*/
#define VCONFKEY_WMS_SUMMARY_PANEL				"db/wms/summary_panel"
