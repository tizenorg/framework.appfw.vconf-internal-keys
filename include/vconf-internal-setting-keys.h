...
#define VCONFKEY_SETAPPL_ACCESSIBILITY_SPEAK_PASSWD_BOOL  "db/setting/accessibility/speak_passwd"
...
#define VCONFKEY_AMD_EFFECT_IMAGE_ENABLE  "db/setting/effect_image"
