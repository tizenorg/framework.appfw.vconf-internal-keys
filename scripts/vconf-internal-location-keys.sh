...
/usr/bin/vconftool set -t int "db/location/setting/GpsPopup"  "1" -s "tizen::vconf::platform::rw"  -g 6514
/usr/bin/vconftool set -t int "db/location/setting/WpsPopup"  "1" -s "tizen::vconf::platform::rw"  -g 6514
...
/usr/bin/vconftool set -t int "memory/location/last/wps/Timestamp"  "0" -s "tizen::vconf::location"  -i  -g 6514
...
/usr/bin/vconftool set -t int "db/location/supl/Port"  "7275" -s "tizen::vconf::platform::rw"  -g 6514
